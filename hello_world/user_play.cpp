...
void user_play::on_pushButton_3_clicked()
{
    ...
    /*ui->lucky->setStyleSheet("image: url(:/img/img/lottery.png);");
    timer->start(1000);
    ui->lucky->setStyleSheet("image: url(:/img/img/1.png);");

    timer->start(1000);
    ui->lucky->setStyleSheet("image: url(:/img/img/2.png);");

    timer->start(1000);
    ui->lucky->setStyleSheet("image: url(:/img/img/3.png);");*/
